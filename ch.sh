...
logo="
${green}  ____                _   _            _
${yellow} / ___|__ _ _ __ ___ | | | | __ _  ___| | _____ _ __
${blue}| |   / _' | '_ ' _ \| |_| |/ _' |/ __| |/ / _ \ '__|
${purple}| |__| (_| | | | | | |  _  | (_| | (__|   <  __/ |
${yellow} \____\__,_|_| |_| |_|_| |_|\__,_|\___|_|\_\___|_|
${red}                                            [v1.2.5]
${blue}                                    [AUTHOR : YOSHI TECH]
"
...
${cyan}[${white}1${cyan}] ${yellow}Yoshi Recharge
${cyan}[${white}2${cyan}] ${yellow}Yoshi Tech
